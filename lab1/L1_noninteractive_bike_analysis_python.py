...
tripData = sc.textFile("/content/drive/MyDrive/Большие_данные_лр1/data/trips.csv")
...
stationData = sc.textFile("/content/drive/MyDrive/Большие_данные_лр1/data/stations.csv")
